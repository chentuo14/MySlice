/****************************************************************************
** Meta object code from reading C++ file 'previewdlg.h'
**
...
#error "The header file 'previewdlg.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 18), // "OnSlideValueChange"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 5) // "value"

    },
    "PreViewDialog\0OnSlideValueChange\0\0"
    "value"
};
...
void PreViewDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnSlideValueChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
